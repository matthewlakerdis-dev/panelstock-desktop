...
async function open(file,draft,readMeasurements){
 ...
 function measurements(){
  ...
  for(let i=0;i<count;i++){
   ...
   const card=make('foreignObject',{x:Math.max(5,Math.min(675,x-150)),y:Math.max(5,Math.min(525,y+12)),width:320,height:470,'data-inline-editor':i});
