...
const files = ['index.html','panelstock-client.js','tailwind.css','icon-192.png','PanelStock_SOP.pdf','push-sw.js','cad/index.html','cad/cad.js','cad/cad-projects.js','cad/cad.css','cad/visual-editor.js','cad/visual-editor.css','cad/editor-theme.css','cad/embedded.js','cad/pdf-selection.js','cad/pdf-selection.css','cad/outline-correction.js','cad/outline-correction.css','cad/measured-outline.js','cad/sketch-components.js'];
...
// Bundle PDF rendering and its fonts/decoders on the same staging origin.
