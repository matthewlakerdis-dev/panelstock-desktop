...
test(repo+': mobile CNC entry keeps the remove button inside the form',()=>assert.match(html,/\.ps-cnc-row\{grid-template-columns:minmax\(0,\.8fr\) minmax\(0,1fr\) minmax\(0,1\.35fr\) 26px\}/));
